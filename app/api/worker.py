...
class PreloadedRqWorker(Worker):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from app.services.booking.store import init_booking_db
        ...
        # Preload the booking DB engine so forked children inherit the cached
        # engine and never call sqlite3.connect() themselves.  Creating a fresh
        # SQLite connection inside a fork()ed child of a multithreaded process
        # is not safe on macOS and causes SIGSEGV.
        _booking_db_engine = init_booking_db()
